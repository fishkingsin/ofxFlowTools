...
namespace flowTools {
	...
	public:
		...
		float	setViscosityVel(float value)		{
			viscosityVel.set(value);
			return 0;
		}
		float	setViscosityDen(float value)		{
			viscosityDen.set(value);
			return 0;
		}
		float	setViscosityTmp(float value)		{
			viscosityTmp.set(value);
			return 0;
		}
